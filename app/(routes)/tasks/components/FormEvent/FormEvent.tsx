...
export  function FormEvent(props: FormEventProps) {
    const {companies, setOpen, setNewEvent, setOnSaveNewEvent} = props
    ...
    const handleCompanyChange = (newValenue: string ) => {
        const selectedCompany = companies.find(company => company.name === newValenue)
        if (selectedCompany) {
            setSelectedCompany ({
                ...
                <FormField 
                    ...
                    render={( { field }) => (
                        <FormItem>
                            ...
                            <FormDescription>Trhis is your event name.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
